...
- The standard error of a sum or difference can be approximated by the square root of the sum of squared errors: $\text{SE}(X_1\pmX_2)=\sqrt{\text{SE}(X_1)^2+\text{SE}(X_2)^2}$;
