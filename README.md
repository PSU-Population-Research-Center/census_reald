...
# Downloads
Downloads are currently available as Stata datasets only, containing fields identifying the geography (stcofips, the state and or county FIPS codes), the subpopulation for which the estimates are generated, and the estimate (b) and standard error of the estimate (se).<br />
